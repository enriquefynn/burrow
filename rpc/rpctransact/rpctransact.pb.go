...
func (*CallCodeParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpctransact_f746c8b9416be0c1, []int{0}
}
...
func (*TxEnvelope) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpctransact_f746c8b9416be0c1, []int{1}
}
...
type TxEnvelopeBatchParam struct {
	Envelope             []*txs.Envelope `protobuf:"bytes,1,rep,name=Envelope" json:"Envelope,omitempty"`
...
func (*TxEnvelopeBatchParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpctransact_f746c8b9416be0c1, []int{2}
}
...
func (m *TxEnvelopeBatchParam) GetEnvelope() []*txs.Envelope {
	if m != nil {
		return m.Envelope
	}
	return nil
...
func (*ReceiptBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpctransact_f746c8b9416be0c1, []int{3}
}
...
func (*TxEnvelopeParam) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpctransact_f746c8b9416be0c1, []int{4}
}
...
func (m *TxEnvelopeBatchParam) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Envelope = append(m.Envelope, &txs.Envelope{})
...
func init() { proto.RegisterFile("rpctransact.proto", fileDescriptor_rpctransact_f746c8b9416be0c1) }
func init() {
	golang_proto.RegisterFile("rpctransact.proto", fileDescriptor_rpctransact_f746c8b9416be0c1)
}

var fileDescriptor_rpctransact_f746c8b9416be0c1 = []byte{
	// 629 bytes of a gzipped FileDescriptorProto
	,
}
