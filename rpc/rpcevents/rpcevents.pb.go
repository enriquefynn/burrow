...
func (Bound_BoundType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_rpcevents_a4502aa9649af806, []int{8, 0}
}
...
func (*SignedHeadersResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpcevents_a4502aa9649af806, []int{0}
}
...
func (*SignedHeadersResult) XXX_MessageName() string {
	return "rpcevents.SignedHeadersResult"
}
...
func (*TxExecution) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpcevents_a4502aa9649af806, []int{1}
}
...
func (*GetBlockRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpcevents_a4502aa9649af806, []int{2}
}
...
func (*TxRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpcevents_a4502aa9649af806, []int{3}
}
...
func (*BlocksRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpcevents_a4502aa9649af806, []int{4}
}
...
func (*EventsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpcevents_a4502aa9649af806, []int{5}
}
...
func (*GetTxsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpcevents_a4502aa9649af806, []int{6}
}
...
func (*GetTxsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpcevents_a4502aa9649af806, []int{7}
}
...
func (*Bound) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpcevents_a4502aa9649af806, []int{8}
}
...
func (*BlockRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_rpcevents_a4502aa9649af806, []int{9}
}
...
func init() {
	proto.RegisterType((*SignedHeadersResult)(nil), "rpcevents.SignedHeadersResult")
	golang_proto.RegisterType((*SignedHeadersResult)(nil), "rpcevents.SignedHeadersResult")
	proto.RegisterType((*TxExecution)(nil), "rpcevents.TxExecution")
	golang_proto.RegisterType((*TxExecution)(nil), "rpcevents.TxExecution")
...
type ExecutionEventsClient interface {
	...
	StreamSignedHeaders(ctx context.Context, in *BlocksRequest, opts ...grpc.CallOption) (ExecutionEvents_StreamSignedHeadersClient, error)
}
...
func (c *executionEventsClient) StreamSignedHeaders(ctx context.Context, in *BlocksRequest, opts ...grpc.CallOption) (ExecutionEvents_StreamSignedHeadersClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ExecutionEvents_serviceDesc.Streams[2], "/rpcevents.ExecutionEvents/StreamSignedHeaders", opts...)
	if err != nil {
		return nil, err
	}
	x := &executionEventsStreamSignedHeadersClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type ExecutionEvents_StreamSignedHeadersClient interface {
	Recv() (*SignedHeadersResult, error)
	grpc.ClientStream
}

type executionEventsStreamSignedHeadersClient struct {
	grpc.ClientStream
}

func (x *executionEventsStreamSignedHeadersClient) Recv() (*SignedHeadersResult, error) {
...
type ExecutionEventsServer interface {
	...
	StreamSignedHeaders(*BlocksRequest, ExecutionEvents_StreamSignedHeadersServer) error
}
...
func _ExecutionEvents_StreamSignedHeaders_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(BlocksRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ExecutionEventsServer).StreamSignedHeaders(m, &executionEventsStreamSignedHeadersServer{stream})
}

type ExecutionEvents_StreamSignedHeadersServer interface {
	Send(*SignedHeadersResult) error
	grpc.ServerStream
}

type executionEventsStreamSignedHeadersServer struct {
	grpc.ServerStream
}

func (x *executionEventsStreamSignedHeadersServer) Send(m *SignedHeadersResult) error {
	return x.ServerStream.SendMsg(m)
}
...
var _ExecutionEvents_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "StreamSignedHeaders",
			Handler:       _ExecutionEvents_StreamSignedHeaders_Handler,
			ServerStreams: true,
		},
	},
...
func (m *SignedHeadersResult) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SignedHeader != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintRpcevents(dAtA, i, uint64(m.SignedHeader.Size()))
...
func (m *TxExecution) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Exception != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintRpcevents(dAtA, i, uint64(m.Exception.Size()))
		n3, err := m.Exception.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n3
...
func (m *TxRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintRpcevents(dAtA, i, uint64(m.TxHash.Size()))
	n4, err := m.TxHash.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n4
...
func (m *BlocksRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BlockRange != nil {
		...
		n5, err := m.BlockRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *BlockRange) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Start != nil {
		...
		n6, err := m.Start.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func init() { proto.RegisterFile("rpcevents.proto", fileDescriptor_rpcevents_a4502aa9649af806) }
func init() { golang_proto.RegisterFile("rpcevents.proto", fileDescriptor_rpcevents_a4502aa9649af806) }

var fileDescriptor_rpcevents_a4502aa9649af806 = []byte{
	// 722 bytes of a gzipped FileDescriptorProto
	,
}
